...
## Corpus Check
- 135 files · ~73,741 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1137 nodes · 1466 edges · 136 communities (105 shown, 31 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 22 edges (avg confidence: 0.83)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `dc64efa8`
...
Cohesion: 0.14
Nodes (22): cancelAutoBid(), getMyAutoBid(), processAutoBids(), defaultAuction, dutchAuction, sealedAuction, secondAutoBid, topAutoBid (+14 more)

### Community 6 - "Financial Integrity Core"
Cohesion: 0.14
Nodes (17): bullMQConnection, deleteAllNotifications(), deleteNotification(), getNotifications(), markRead(), consoleSpy, mockNotification, auctionQueue (+9 more)
...
Cohesion: 0.25
Nodes (16): buyNow(), cancelAuction(), createAuction(), getAuctionById(), getAuctions(), mockData, updateAuction(), setAutoBid() (+8 more)
...
Cohesion: 0.18
Nodes (11): router, router, router, authenticate(), CachedUser, cacheGet(), cacheSet(), requireAdmin() (+3 more)

### Community 15 - "Security & Middleware"
Cohesion: 0.18
Nodes (10): initSocketGateway(), nextFn, redis, redisPub, redisSub, app, bootstrap(), ExtendedRequest (+2 more)
...
Cohesion: 0.2
Nodes (10): AppError, errorHandler(), err, issues, nextFunction, zodError, addToWatchlist(), getWatchlist() (+2 more)
...
## Knowledge Gaps
- **597 isolated node(s):** `fs`, `path`, `srcDir`, `ignorePatterns`, `files` (+592 more)
...
- **Why does `io` connect `Financial Integrity Core` to `Frontend Pages & UI`, `Auction Create Form`, `Security & Middleware`?**
  _High betweenness centrality (0.035) - this node is a cross-community bridge._
- **Why does `getSocket()` connect `Frontend Pages & UI` to `Financial Integrity Core`?**
  _High betweenness centrality (0.035) - this node is a cross-community bridge._
- **Why does `AuctionHaus Backend — Full Technical Deep Dive` connect `Landing Page` to `Development Rules`, `Phase Tracker`, `Frontend QA Review`, `Community 74`, `Community 75`, `Community 47`, `Community 48`, `PostCSS Config`, `Community 55`, `Community 56`, `Backend ESLint`, `Community 62`, `Community 63`?**
