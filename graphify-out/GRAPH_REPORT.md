...
## Corpus Check
- 191 files · ~102,788 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1635 nodes · 2193 edges · 173 communities (137 shown, 36 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 27 edges (avg confidence: 0.83)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `1892e6c8`
...
Cohesion: 0.06
Nodes (40): AuthHeroPanel(), AddWatchlistInput, addWatchlistSchema, AUCTION_TYPES, AuctionType, CreateAuctionInput, createAuctionSchema, LoginInput (+32 more)
...
Cohesion: 0.09
Nodes (22): explain(), NORM_PARAMS, normalise(), score(), sigmoid(), WEIGHTS, FraudEngine, extractFeatures() (+14 more)

### Community 4 - "Prisma Client & Scripts"
Cohesion: 0.12
Nodes (26): cancelAutoBid(), getMyAutoBid(), processAutoBids(), setAutoBid(), defaultAuction, dutchAuction, sealedAuction, secondAutoBid (+18 more)
...
Cohesion: 0.09
Nodes (20): placeBid(), placeBidStream(), bid, commitBid(), getCommitments(), hashCommitment(), revealBid(), toCents() (+12 more)

### Community 7 - "User Profile Controllers"
Cohesion: 0.1
Nodes (20): AuctionState, BidDecision, CollusionAgent, ShillAgent, SniperAgent, TruthfulAgent, createAuction(), DURATION_SEC (+12 more)
...
Cohesion: 0.1
Nodes (21): AdminPage(), AuctionsPage(), AuthProvider(), Navbar(), AuctionRowData, BidRowData, DashboardPage(), AdminFraudPage() (+13 more)
...
Cohesion: 0.16
Nodes (18): settleWithinTx(), D(), DecimalInput, isDecimalLike(), neg(), toNum(), deposit(), getTransactions() (+10 more)
...
Cohesion: 0.21
Nodes (16): buyNow(), cancelAuction(), createAuction(), getAuctionById(), getAuctions(), mockData, updateAuction(), serializeMoney() (+8 more)

### Community 15 - "Security & Middleware"
Cohesion: 0.15
Nodes (13): nextFunction, AsymmetricMatcher, m(), prisma, prismaMock, confirmWinnerPayment(), refundLosers(), defaultAuction (+5 more)

### Community 16 - "API Routes & Catalogue"
Cohesion: 0.11
Nodes (13): api, AUTH_CRITICAL_PATHS, isAuthCritical, parseApiError(), token, ProfilePage(), Transaction, TYPE_LABEL (+5 more)

### Community 17 - "Frontend ESLint Config"
Cohesion: 0.15
Nodes (11): AdminStats, Tab, Auction, AuctionCard(), lotNumber(), disconnectSocket(), getSocket(), reconnectSocket() (+3 more)

### Community 18 - "Next.js Config"
Cohesion: 0.16
Nodes (11): router, router, query, router, router, authenticate(), CachedUser, cacheGet() (+3 more)

### Community 19 - "PostCSS Config"
Cohesion: 0.14
Nodes (11): AuctionForPrice, AuctionMeta(), AutoBidPanel(), AutoBidState, BidForm(), DutchAccept(), PricePanel(), WinnerCertificate() (+3 more)
...
Cohesion: 0.16
Nodes (12): initSocketGateway(), nextFn, bullMQConnection, redis, redisInvalidateSub, redisPub, redisSub, app (+4 more)
...
Cohesion: 0.29
Nodes (7): 2. Critical Concurrency & Race Condition Audits (The "Wow" Factor for Teachers), code:typescript (const auction = await tx.auction.findUnique({ where: { id: a), code:typescript (return prisma.$transaction(async (tx) => {), The Architectural Solution (True Pessimistic Locking), The Bug (Current Implementation), The Concurrency Issue, Vulnerability 2: Standard `findUnique` Does NOT Pessimistically Lock in `placeBid`
...
- **Why does `getSocket()` connect `Frontend ESLint Config` to `Product Requirements`, `Notification Controllers`, `Prisma Client & Scripts`, `Backend Architecture`?**
  _High betweenness centrality (0.062) - this node is a cross-community bridge._
- **Why does `io` connect `Prisma Client & Scripts` to `Frontend ESLint Config`, `Route Middleware`, `Auto-Bid Algorithm`?**
  _High betweenness centrality (0.062) - this node is a cross-community bridge._
- **Why does `createError()` connect `Financial Integrity Core` to `Prisma Client & Scripts`, `File Icon Asset`, `Route Middleware`, `Real-Time Socket Layer`, `Security & Middleware`, `Community 49`, `Community 85`?**
