# Graph Report - auctionhaus  (2026-05-29)

## Corpus Check
- 140 files · ~78,385 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1163 nodes · 1512 edges · 144 communities (114 shown, 30 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 22 edges (avg confidence: 0.83)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `3d4a98d3`
...
1. `createError()` - 39 edges
2. `serializeMoney()` - 28 edges
3. `useAuthStore` - 25 edges
4. `AuctionHaus Backend — Full Technical Deep Dive` - 19 edges
...
Cohesion: 0.15
Nodes (18): cancelAutoBid(), getMyAutoBid(), processAutoBids(), setAutoBid(), defaultAuction, dutchAuction, sealedAuction, secondAutoBid (+10 more)

### Community 5 - "Auction Create Form"
Cohesion: 0.14
Nodes (18): deleteAllNotifications(), deleteNotification(), getNotifications(), markRead(), notifyUser(), consoleSpy, mockNotification, auctionQueue (+10 more)

### Community 6 - "Financial Integrity Core"
Cohesion: 0.14
Nodes (13): router, router, authenticate(), AuthRequest, CachedUser, cacheGet(), cacheSet(), requireAdmin() (+5 more)

### Community 7 - "User Profile Controllers"
Cohesion: 0.15
Nodes (14): getAuctionBids(), defaultAuction, dutchAuction, prevBid, AsymmetricMatcher, m(), prisma, prismaMock (+6 more)

### Community 8 - "Frontend Architecture"
Cohesion: 0.25
Nodes (15): buyNow(), cancelAuction(), createAuction(), getAuctionById(), getAuctions(), mockData, updateAuction(), isDecimalLike() (+7 more)
...
Cohesion: 0.17
Nodes (11): initSocketGateway(), nextFn, bullMQConnection, redis, redisInvalidateSub, redisPub, redisSub, app (+3 more)
...
Cohesion: 0.24
Nodes (7): cancelAutoBid(), getMyAutoBid(), setAutoBid(), mockResult, nextFunction, router, router
...
Cohesion: 0.22
Nodes (8): 12. Watchlist, 15. Request Lifecycle (End to End), 1. Tech Stack & Why, AuctionHaus Backend — Full Technical Deep Dive, code:typescript (@@unique([userId, auctionId])  // can't add same auction twi), code:typescript (prisma.watchlistItem.upsert({), code:block48 (Browser (Alice)                 Server                      ), Table of Contents
...
Cohesion: 0.32
Nodes (6): AppError, errorHandler(), err, issues, nextFunction, zodError
...
Cohesion: 0.5
Nodes (4): 2. Project Entry Point, code:block1 (1. Load environment variables (.env)), code:typescript (const app = express();), code:typescript (app.use((req, _res, next) => {)
...
## Knowledge Gaps
- **613 isolated node(s):** `fs`, `path`, `srcDir`, `ignorePatterns`, `files` (+608 more)
...
- **Why does `getSocket()` connect `Frontend Pages & UI` to `Auction Create Form`?**
  _High betweenness centrality (0.037) - this node is a cross-community bridge._
- **Why does `io` connect `Auction Create Form` to `Frontend Pages & UI`, `Prisma Client & Scripts`, `Database Schema Design`, `User Profile Controllers`?**
  _High betweenness centrality (0.037) - this node is a cross-community bridge._
- **Why does `AuctionHaus Backend — Full Technical Deep Dive` connect `Next.js Config` to `Community 64`, `Development Rules`, `Phase Tracker`, `Community 65`, `Product Requirements`, `Community 47`, `Community 48`, `Community 80`, `Community 81`, `PostCSS Config`, `Design System Philosophy`, `Community 59`, `Community 60`?**
