...
## Corpus Check
- 188 files · ~100,118 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1553 nodes · 2098 edges · 175 communities (139 shown, 36 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 27 edges (avg confidence: 0.83)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `4ca34174`
...
7. `AuctionHaus — Complete System Documentation` - 16 edges
8. `done` - 16 edges
9. `SESSION CLOSED — Where We Are Leaving (read this first next session)` - 16 edges
10. `AuctionHaus — Complete System Documentation` - 16 edges
...
Cohesion: 0.11
Nodes (23): defaultAuction, dutchAuction, prevBid, AsymmetricMatcher, m(), prisma, prismaMock, deleteAllNotifications() (+15 more)
...
Cohesion: 0.18
Nodes (22): buyNow(), cancelAuction(), createAuction(), getAuctionById(), getAuctions(), mockData, updateAuction(), serializeMoney() (+14 more)

### Community 10 - "App Layout & Providers"
Cohesion: 0.11
Nodes (19): initSocketGateway(), nextFn, bullMQConnection, redis, redisInvalidateSub, redisPub, redisSub, app (+11 more)

### Community 11 - "Route Middleware"
Cohesion: 0.12
Nodes (15): router, router, router, authenticate(), CachedUser, cacheGet(), cacheSet(), requireAdmin() (+7 more)

### Community 12 - "Auction Scheduler & Dutch"
Cohesion: 0.1
Nodes (5): globalForPrisma, addToWatchlist(), getWatchlist(), removeFromWatchlist(), mockItems

### Community 13 - "Database Schema Design"
Cohesion: 0.13
Nodes (11): Bid, BidHistory(), AuctionForInfo, InfoPanel(), KeyDetails(), TYPE_INFO, Auction, AuctionDetailPage() (+3 more)
...
Cohesion: 0.19
Nodes (11): AdminPage(), AdminStats, Tab, AuctionsPage(), AuthProvider(), Navbar(), DashboardPage(), AdminFraudPage() (+3 more)
...
Cohesion: 0.13
Nodes (14): 11. Security Measures, 12. Test Accounts (from seed), 13. Known Issues (from checklist.md), 14. Data Flow: Bid Placement, 15. Data Flow: Auction End, 1. What This Codebase Does, 2. Folder Structure, 3. Environment Variables (+6 more)
...
Cohesion: 0.23
Nodes (8): disconnectSocket(), getSocket(), reconnectSocket(), Listener, actionBtn, Notification, TYPE_META, TYPE_TONE
...
Cohesion: 0.2
Nodes (9): api, AUTH_CRITICAL_PATHS, isAuthCritical, parseApiError(), token, ProfilePage(), Transaction, TYPE_LABEL (+1 more)
...
Cohesion: 0.22
Nodes (4): errStyle, successStyle, Transaction, WalletPage()
...
Cohesion: 0.25
Nodes (4): query, router, AuthRequest, result

### Community 73 - "Community 73"
Cohesion: 0.29
Nodes (3): markAllRead(), markRead(), result

### Community 74 - "Community 74"
Cohesion: 0.25
Nodes (6): AuthState, User, TYPE_BADGE, TYPE_LABEL, WatchItem, WatchlistPage()
...
Cohesion: 0.43
Nodes (4): auctionQueue, autoBidQueue, dutchAuctionQueue, notificationQueue
...
## Knowledge Gaps
- **763 isolated node(s):** `fs`, `path`, `srcDir`, `ignorePatterns`, `files` (+758 more)
...
- **Why does `getSocket()` connect `English Auction & Sniping` to `Auction Create Form`, `Database Schema Design`, `PostCSS Config`, `Community 85`, `Community 86`?**
  _High betweenness centrality (0.067) - this node is a cross-community bridge._
- **Why does `io` connect `Auction Create Form` to `Frontend Architecture`, `English Auction & Sniping`, `App Layout & Providers`?**
  _High betweenness centrality (0.067) - this node is a cross-community bridge._
- **Why does `createError()` connect `Notification Controllers` to `Community 96`, `Auction Create Form`, `Frontend Architecture`, `Community 44`, `Community 45`, `Auction Scheduler & Dutch`, `Community 84`, `Request Lifecycle`?**
