...
## Corpus Check
- 134 files · ~68,480 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1101 nodes · 1409 edges · 136 communities (105 shown, 31 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 22 edges (avg confidence: 0.83)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `c641846c`
...
Cohesion: 0.15
Nodes (21): cancelAutoBid(), getMyAutoBid(), processAutoBids(), setAutoBid(), defaultAuction, dutchAuction, sealedAuction, secondAutoBid (+13 more)
...
Cohesion: 0.16
Nodes (11): router, initSocketGateway(), nextFn, rateLimiter, strictRateLimiter, app, bootstrap(), ExtendedRequest (+3 more)
...
Cohesion: 0.11
Nodes (17): Acceptance signals for the user to run, Commit, Context Loaded, Goal, Log, New helper, Next Up, Notes for Future Self (+9 more)
...
Cohesion: 0.16
Nodes (11): getAuctionBids(), defaultAuction, dutchAuction, prevBid, AsymmetricMatcher, m(), confirmWinnerPayment(), refundLosers() (+3 more)
...
Cohesion: 0.36
Nodes (7): deleteAllNotifications(), deleteNotification(), getNotifications(), markRead(), consoleSpy, mockNotification, io

### Community 44 - "Community 44"
Cohesion: 0.33
Nodes (6): prisma, prismaMock, addToWatchlist(), getWatchlist(), removeFromWatchlist(), mockItems
...
## Knowledge Gaps
- **572 isolated node(s):** `fs`, `path`, `srcDir`, `ignorePatterns`, `files` (+567 more)
...
- **Why does `io` connect `Community 43` to `Frontend Pages & UI`, `Auction Scheduler & Dutch`, `Prisma Client & Scripts`, `User Profile Controllers`?**
  _High betweenness centrality (0.041) - this node is a cross-community bridge._
- **Why does `getSocket()` connect `Frontend Pages & UI` to `Community 43`?**
  _High betweenness centrality (0.041) - this node is a cross-community bridge._
- **Why does `AuctionHaus Backend — Full Technical Deep Dive` connect `PostCSS Config` to `Community 64`, `Development Rules`, `Community 65`, `Product Requirements`, `Community 59`, `Community 74`, `Community 75`, `Community 49`, `Community 50`, `Next.js Config`, `Backend ESLint`, `Community 60`, `Request Lifecycle`?**
